      ...
      <div className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-gray-900">검색 결과</h1>
              <p className="text-gray-500">"{query}"에 대한 결과 {results.length}건</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-gray-100 rounded-xl px-4 py-3 mb-6">
          <p className="text-sm text-gray-600">
            현재 지역: <span className="text-gray-900">{region.city} {region.district}</span>
          </p>
        </div>
        ...
        {results.length === 0 && (
          <div className="mt-6 bg-blue-50 border border-blue-100 rounded-xl p-4">
            <p className="text-sm text-blue-900 mb-2">💡 검색 팁</p>
